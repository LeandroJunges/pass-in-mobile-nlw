...
export default function Register(){
    ...
    const handleRegister = async ()=>{
        try {
            ...
            setIsLoading(true)
           const registerReponse = await api.post(`/events/${EVENT_ID}/attendees`, {
                name,
                email,
            })

            if(registerReponse.data.attendeeId){
                const badgeResponse = await api.get(`/attendees/${registerReponse.data.attendeeId}/badge`)
    ...
    return (
        <View className="flex-1 bg-green-500 items-center justify-center p-8 " >
            ...
            <View className=" w-full mt-12 gap-3 " >
                ...
                <Button title="Relizar inscrição" onPress={handleRegister} isLoading={isLoading} />
